...
$ curl -s localhost:8471/readyz
  {"status":"ready","api_version":"1.0","schema_revision":"58c81c09d101"}
```
...
# sudo -u subroutine env \
  ...
  Upgraded from f159c8635e54 to 58c81c09d101.
```
...
# sudo -u subroutine env \
    ...
    XDG_STATE_HOME=/var/lib/subroutine/state \
    /opt/subroutine/bin/subroutine db current
  Schema is at 4f177421eb91; newest is 58c81c09d101.
```

When the two match it says so in one line - `Schema is at 58c81c09d101.` - and there is nothing
to do.
