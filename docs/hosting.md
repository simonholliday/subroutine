...
$ curl -s localhost:8471/readyz
  {"status":"ready","api_version":"1.0","schema_revision":"4f177421eb91"}
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema 4f177421eb91.
  ...
  Upgraded from f159c8635e54 to 4f177421eb91.
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema 4f177421eb91.
  The database is at 4f177421eb91.
  Nothing to do.
```
...
$ subroutine agenda
  ...
  Local: This database is at schema 233f898a2bee, and this build expects 4f177421eb91.
