...
$ curl -s localhost:8471/readyz
  {"status":"ready","api_version":"1.0","schema_revision":"4240ca248de1"}
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema 4240ca248de1.
  ...
  Upgraded from f159c8635e54 to 4240ca248de1.
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema 4240ca248de1.
  The database is at 4240ca248de1.
  Nothing to do.
```
...
$ subroutine agenda
  ...
  Local: This database is at schema 233f898a2bee, and this build expects 4240ca248de1.
