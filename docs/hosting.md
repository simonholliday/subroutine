...
$ curl -s localhost:8471/readyz
  {"status":"ready","api_version":"1.0","schema_revision":"7eba0170ad83"}
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema 7eba0170ad83.
  ...
  Upgraded from f159c8635e54 to 7eba0170ad83.
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema 7eba0170ad83.
  The database is at 7eba0170ad83.
  Nothing to do.
```
...
$ subroutine agenda
  ...
  Local: This database is at schema 233f898a2bee, and this build expects 7eba0170ad83.
