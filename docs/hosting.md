...
$ curl -s localhost:8471/readyz
  {"status":"ready","api_version":"1.0","schema_revision":"a1b3cef13c45"}
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema a1b3cef13c45.
  ...
  Upgraded from f159c8635e54 to a1b3cef13c45.
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema a1b3cef13c45.
  The database is at a1b3cef13c45.
  Nothing to do.
```
...
$ subroutine agenda
  ...
  Local: This database is at schema 233f898a2bee, and this build expects a1b3cef13c45.
