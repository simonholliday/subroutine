...
$ curl -s localhost:8471/readyz
  {"status":"ready","api_version":"1.0","schema_revision":"59c627e98f2d"}
```
...
$ subroutine doctor
  ...
  local    0.2.1, schema 59c627e98f2d, as si (person)
...
```console
$ subroutine upgrade
  This version expects schema 59c627e98f2d.
  ...
  Upgraded from 547fe53b263c to 59c627e98f2d.
```
...
$ subroutine upgrade
  This version expects schema 59c627e98f2d.
  The database is at 59c627e98f2d.
  Nothing to do.
```
...
$ subroutine today
  ...
  Local: This database is at schema 233f898a2bee, and this build expects 59c627e98f2d.
