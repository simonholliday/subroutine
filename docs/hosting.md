...
$ curl -s localhost:8471/readyz
  {"status":"ready","api_version":"1.0","schema_revision":"491e1a09de04"}
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema 491e1a09de04.
  ...
  Upgraded from f159c8635e54 to 491e1a09de04.
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema 491e1a09de04.
  The database is at 491e1a09de04.
  Nothing to do.
```
...
$ subroutine agenda
  ...
  Local: This database is at schema 233f898a2bee, and this build expects 491e1a09de04.
