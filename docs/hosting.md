...
$ curl -s localhost:8471/readyz
  {"status":"ready","api_version":"1.0","schema_revision":"da7628199bff"}
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema da7628199bff.
  ...
  Upgraded from f159c8635e54 to da7628199bff.
```
...
$ subroutine db upgrade
  Subroutine 0.7.1 expects schema da7628199bff.
  The database is at da7628199bff.
  Nothing to do.
```
...
$ subroutine agenda
  ...
  Local: This database is at schema 233f898a2bee, and this build expects da7628199bff.
